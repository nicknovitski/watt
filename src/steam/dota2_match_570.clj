(ns steam.dota2-match-570 (:require [steam.core :refer [request]]))

(def
 league-listing-v1
 (partial request "GET" "IDOTA2Match_570" "GetLeagueListing" 1))
...
:match_id (uint64) - Only show matches of the specified match id (optional)"
 (partial request "GET" "IDOTA2Match_570" "GetLiveLeagueGames" 1))
...
:match_id (uint64) - Match id"
 (partial request "GET" "IDOTA2Match_570" "GetMatchDetails" 1))
...
:tournament_games_only (string) - Whether or not tournament games should only be returned (optional)"
 (partial request "GET" "IDOTA2Match_570" "GetMatchHistory" 1))
...
:date_max (uint32) - The ending time stamp. If this is more than 7 days past the starting time stamp, it will be clamped to 7 days. (optional)"
 (partial request "GET" "IDOTA2Match_570" "GetScheduledLeagueGames" 1))
...
:teams_requested (uint32) (optional)"
 (partial request "GET" "IDOTA2Match_570" "GetTeamInfoByTeamID" 1))
...
:match_id (uint64) (optional)"
 (partial request "GET" "IDOTA2Match_570" "GetTournamentPlayerStats" 1))
